...
public class EditaUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editaSobrenomeUsuario =  (EditText) findViewById(R.id.sobrenomeTxt2);
        ...
        editaSobrenomeUsuario.setText(bundle.getString("sobrenome"));
    ...
    public void alteraUsuario(View v){
        try {
            ...
            bean.setSobrenome(editaSobrenomeUsuario.getText().toString());
