...
public class VerUsuario extends AppCompatActivity {
    ...
    TextView verNomeUsuario, verCpfUsuario, verLoginUsuario, verIdUsuario, verSobrenomeUsuario;
    Intent intent = null;
    Usuario bean;
    ...
    protected void carregarDados() {
        ...
        verSobrenomeUsuario = (TextView) findViewById(R.id.verSobrenomeUsuario);
        ...
        bean.setSobrenome(cursor.getString(cursor.getColumnIndexOrThrow("sobrenome")));
        verSobrenomeUsuario.setText(verSobrenomeUsuario.getText().toString() + bean.getSobrenome());
    ...
    public void editarUsuario(View v) {
        ...
        intent.putExtra("sobrenome", bean.getSobrenome());
