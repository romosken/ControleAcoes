...
public class ListaUsuario extends AppCompatActivity {
    ...
    protected void carregarDados() {
        try {
            ...
            String[] nomeCampos = {"_id", "nome","sobrenome", "cpf", "login"};
            int[] idViewLayout = {R.id.idUsuarioLayout, R.id.nomeUsuarioLayout,R.id.sobrenomeUsuarioLayout, R.id.cpfUsuarioLayout, R.id.loginUsuarioLayout};
